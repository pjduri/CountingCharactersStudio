...
string fileText = File.ReadAllText(@"./sampleText.txt");

Console.WriteLine("Enter some text, or you can leave blank");
Console.WriteLine("to tally up some song lyrics,");
Console.WriteLine("or type 'L' to get the good ol' Lorem Ipsum");
